...
interface DeleteButtonProps<RecordType extends RaRecord = any> extends Omit<ButtonProps, 'record'> {
    className?: string;
    confirmTitle?: string;
...
declare const ShowGuesser: ({ id, queryOptions, ...rest }: ShowProps) => JSX.Element;
...
interface FormTabProps extends StackProps {
    className?: string;
    children?: ReactNode;
    contentClassName?: string;
    hidden?: boolean;
 ...
 * );
 */
declare const ListGuesser: <RecordType extends RaRecord = any>() => JSX.Element;
