...
var require_Get = __commonJS({
  "node_modules/es-abstract/2021/Get.js"(exports, module) {
    ...
    module.exports = function Get(O, P2) {
      if (Type(O) !== "Object") {
...
var require_HasProperty = __commonJS({
  "node_modules/es-abstract/2021/HasProperty.js"(exports, module) {
    ...
    var IsPropertyKey = require_IsPropertyKey();
    var Type = require_Type2();
    module.exports = function HasProperty(O, P2) {
      if (Type(O) !== "Object") {
...
var require_shim = __commonJS({
  "node_modules/array.prototype.foreach/shim.js"(exports, module) {
    ...
    module.exports = function shimForEach() {
      ...
      define(Array.prototype, { forEach: polyfill }, { forEach: function() {
...
var f = (r, e) => h(r, "name", { value: e, configurable: true });
var w = f((r, e = "en", s = {}) => {
  let a = e, l = r(e);
  if (l instanceof Promise)
    throw new Error(`The i18nProvider returned a Promise for the messages of the default locale (${e}). Please update your i18nProvider to return the messages of the default locale in a synchronous way.`);
  let i = new import_node_polyglot.default(o({ locale: a, phrases: o({ "": "" }, l) }, s)), g = i.t.bind(i);
  return { translate: (t, n = {}) => g(t, n), changeLocale: (t) => Promise.resolve(r(t)).then((n) => {
    a = t;
    let d = new import_node_polyglot.default(o({ locale: t, phrases: o({ "": "" }, n) }, s));
    g = d.t.bind(d);
  }), getLocale: () => a };
}, "default");
...
//# sourceMappingURL=chunk-JVVQ3MHG.js.map
